"""
Django settings for django_supabase_ventas project.
...
SECRET_KEY = 'django-insecure-%6@)mc!%q=!@rfoio)^zr)$r+w9iurul^rtd##lmk7$^5b6=kl'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = os.getenv('DEBUG', 'False') == 'True'  # False en Vercel
...
ROOT_URLCONF = 'django_supabase_ventas.urls'
...
WSGI_APPLICATION = 'django_supabase_ventas.wsgi.application'
